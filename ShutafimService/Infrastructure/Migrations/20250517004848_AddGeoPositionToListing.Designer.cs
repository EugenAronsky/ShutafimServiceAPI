...
namespace ShutafimService.Migrations
{
    ...
    [Migration("20250517004848_AddGeoPositionToListing")]
    partial class AddGeoPositionToListing
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShutafimService.Domain.Entities.Listing", b =>
                {
                    ...
                    b.Property<int>("UtilitiesCovered")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ShutafimService.Domain.Entities.User", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("LikedMedia")
                        .HasColumnType("text[]");
